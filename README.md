...
git clone https://github.com/aloksahoo242424/Plant-Disease-Detection
...
tensorflow==2.7.0 =======
Plant-Disease-Detection
🌿 A deep learning–powered project that uses Convolutional Neural Networks (CNNs) to detect and classify plant diseases—helping farmers and agricultural experts prevent outbreaks and safeguard crop yields.
